...
class TodoResourceIT {
    ...
    public static Todo createEntity(EntityManager em) {
        Todo todo = new Todo().title(DEFAULT_TITLE).state(DEFAULT_STATE).description(DEFAULT_DESCRIPTION);
        return todo;
    }
    ...
    public static Todo createUpdatedEntity(EntityManager em) {
        Todo todo = new Todo().title(UPDATED_TITLE).state(UPDATED_STATE).description(UPDATED_DESCRIPTION);
        return todo;
    }
    ...
    void putNewTodo() throws Exception {
        ...
        updatedTodo.title(UPDATED_TITLE).state(UPDATED_STATE).description(UPDATED_DESCRIPTION);
    ...
    void partialUpdateTodoWithPatch() throws Exception {
        ...
        partialUpdatedTodo.title(UPDATED_TITLE).state(UPDATED_STATE);
    ...
    void fullUpdateTodoWithPatch() throws Exception {
        ...
        partialUpdatedTodo.title(UPDATED_TITLE).state(UPDATED_STATE).description(UPDATED_DESCRIPTION);
